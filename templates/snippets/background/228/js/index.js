...
function render(){
  ...
  currentCameraPercentage += (cameraTargetPercentage - currentCameraPercentage) / 51
  
  camera.rotation.y += (cameraRotationProxyX - camera.rotation.y) / 25;
  camera.rotation.x += (cameraRotationProxyY - camera.rotation.x) / 25;
