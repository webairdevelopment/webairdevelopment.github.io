var _createClass = function () {function defineProperties(target, props) {for (var i = 0; i < props.length; i++) {var descriptor = props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if ("value" in descriptor) descriptor.writable = true;Object.defineProperty(target, descriptor.key, descriptor);}}return function (Constructor, protoProps, staticProps) {if (protoProps) defineProperties(Constructor.prototype, protoProps);if (staticProps) defineProperties(Constructor, staticProps);return Constructor;};}();function _classCallCheck(instance, Constructor) {if (!(instance instanceof Constructor)) {throw new TypeError("Cannot call a class as a function");}} // Recreating "Mock Chat Animation" by Jacob "Alca" Foster (Me) https://codepen.io/Alca/pen/bWGMoz

var amountOfColors = 18;
var hueRot = 360 / amountOfColors;
var messages = [];
var nextAt = 0;

var chatLineWidth = 500;
var chatLineWidth40 = chatLineWidth * 0.4;
var chatLineWidth60 = chatLineWidth * 0.6;
var chatLineMaxHeight = chatLineWidth40;
var chatLinePadding = 10;
var chatLineRadius = chatLinePadding * 0.5;
var chatLineColor = hsl(0, 0, 14);
var chatProfileImgSize = 60;
var chatProfileImgRadius = chatLinePadding * 0.4;
var chatTextTiming = Array(10).fill(null).map(function (n, i) {return i * 50 + 100;});
var chatTextRadius = chatLinePadding * 0.2;
var chatTextWidth = chatLineWidth - chatLinePadding * 3 - chatProfileImgSize;
var chatTextHeight = 16;
var chatNameTimeWidth = chatTextWidth * 0.122;
var chatNameTimeColor = hsl(0, 0, 22);
var chatLineTextLightness = 28;
var richBodyAndImgLightness = 20;
var chatInputHeight = 40;
var chatInputHeight30 = chatInputHeight * 0.3;
var chatInputHeight40 = chatInputHeight * 0.4;
var chatInputHeight50 = chatInputHeight * 0.5;


function draw(e) {
	translate(-chatLineWidth * 0.5 + width_half, height - chatLinePadding - chatInputHeight);
	messages = messages.filter(function (m) {return 'kill' in m === false;});
	var yOff = -chatLinePadding - chatInputHeight;
...
Message = function () {
	function Message() {var e = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : performance.now();_classCallCheck(this, Message);
		...
		var bodyHeight = Math.max(chatProfileImgSize, (chatLinePadding + chatTextHeight) * ceil(this.text + 1) - chatLinePadding);
		...
		this.created = e;
	}_createClass(Message, [{ key: 'anim', value: function anim()
		{var e = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : performance.now();
			var elapsed = e - this.created;
			var cT = ease.quart.inOut(constrain(elapsed * this.easeHeightTimeI, 0, 1), 0, 1, 1);
			var h = cT * this.totalHeight;
			var mB = cT * chatLinePadding;
			var y = -h - mB;
			var text = chatTextTiming.map(function (n) {
				var t = ease.quart.inOut(constrain((elapsed - n) / 500, 0, 1), 1, -1, 1);
				return { t: t, y: t * chatTextHeight * 2 };
			});
			return { elapsed: elapsed, cT: cT, h: h, mB: mB, y: y, text: text };
		} }, { key: 'draw', value: function draw()
		{var e = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : performance.now();
			push();

			var anim = this.anim(e);var
			h = anim.h,text = anim.text,cT = anim.cT;
			...
			var containerRadius = h < chatLineRadius * 2 ? h * 0.5 : chatLineRadius;
			...
			var ind = 0;
			for (var i = this.text; i > 0; i--, ind++) {
				var w = i > 1 ? chatTextWidth : i * chatTextWidth;var _text =
				text[ind + 1],y = _text.y,t = _text.t;
				beginPath();
			...
			if (this.img || this.richBody) {var _text2 =
				text[ind + 1],y = _text2.y,t = _text2.t;
				beginPath();
				if (this.richBody) {
